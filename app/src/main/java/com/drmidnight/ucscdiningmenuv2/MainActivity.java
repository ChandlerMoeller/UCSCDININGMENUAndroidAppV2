...
//                else menuItem.setChecked(true);
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.myucsc:
                        ...
                        myucscfragment myucscfragment = new myucscfragment();
                        android.support.v4.app.FragmentTransaction myucscfragmentTransaction = getSupportFragmentManager().beginTransaction();
                        myucscfragmentTransaction.replace(R.id.frame, myucscfragment);
                        myucscfragmentTransaction.commit();
                        return true;
                    case R.id.ecommons:
                        ...
                        ecommonsfragment ecommonsfragment = new ecommonsfragment();
                        android.support.v4.app.FragmentTransaction ecommonsfragmentTransaction = getSupportFragmentManager().beginTransaction();
                        ecommonsfragmentTransaction.replace(R.id.frame, ecommonsfragment);
                        ecommonsfragmentTransaction.commit();
                        return true;
                    case R.id.piazza:
                        ...
                        android.support.v4.app.FragmentTransaction piazzafragmentTransaction = getSupportFragmentManager().beginTransaction();
                        piazzafragmentTransaction.replace(R.id.frame, piazzafragment);
                        piazzafragmentTransaction.commit();
                        return true;
                    case R.id.settings:
                    ...
                    case R.id.about:
                        ...
                        return true;
                    default:
                        Toast.makeText(getApplicationContext(), "This is not supposed to happen", Toast.LENGTH_SHORT).show();
                        return true;
        ...
        prevMenuItem = navigationView.getMenu().findItem(R.id.bycurrentmeal);
